...
<!-- Navbar brand -->
<a class="navbar-brand" href="main.php"><b class="align-center" style="font-size:25px;"><img src="img/grupa.PNG" alt="Strona główna" width="40" height="40">ount it!</b></a>
...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="logout.php"><b>Wyloguj</b></a>
    </li>
